<div class="sidebarzz w3-bar-block w3-card" style="display:none" id="mySidebar">
    ...
    <nav class="nav flex-column">
        <?php if(session()->get('user_level') == 'admin' || session()->get('user_level') == 'agent_branch' || session()->get('user_level') == 'agent_cluster' ){ ?>
        ...
        <?php } else if(session()->get('user_level') == 'admin' || session()->get('user_level') == 'admin_cms'){ ?>
